...
CreateConVar("randomat_snails_cap", 12, FCVAR_NONE, "Maximum number of snails spawned", 0, 15)
CreateConVar("randomat_snails_delay", 0.5, FCVAR_NONE, "Delay before snails are spawned", 0.1, 2.0)
CreateConVar("randomat_snails_music", 1, FCVAR_NONE, "Music plays while randomat is active")
